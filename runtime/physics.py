...
class SpatialHash:
    ...
    def _get_cells_for_rect(self, rect):
        ...
        # Rect right/bottom logic:
        # If right is exactly on boundary (e.g. 100), we typically consider it IN the previous cell [0, 100)
        # unless it has 0 width.
        # However, AABB overlap usually implies inclusive bounds.
        # Let's use standard inclusive range of cells touched by the float rect.
        # But pygame rects are integers usually.
        # We'll stick to bottom-right corner logic.
